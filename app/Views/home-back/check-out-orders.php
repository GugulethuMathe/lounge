                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Check Out Orders</h4>
                        </div>
                        <div class="card-body">
                            <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap w-100">
                                ...
                                <tbody>
                                    ...
                                    $query = $db->query("SELECT * FROM customers WHERE  event_status ='Check_out'");
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                            <button type="button" class="btn btn-danger btn-sm waves-effect waves-light" data-bs-toggle="modal" data-id="<?= $row->id; ?>" data-bs-target="#exampleModalFullscreen-<?= $row->id ?>"><i class="fa fa-eye">Delete</i></button>
