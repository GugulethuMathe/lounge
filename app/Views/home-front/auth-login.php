...
<head>
    ...
    <meta charset="utf-8" />
    <title>Login | Iziko de Lounge</title>
                        ...
                        <div class="d-flex flex-column h-100">
                            <div class="mb-4 mb-md-5 text-center">
                                <a href="/" class="d-block auth-logo">
                                    <img src="assets/images/izikologo.png" alt="" height="158"> <span class="logo-txt"></span>
                                </a>
                            </div>
                            <div class="auth-content my-auto">
                                <div class="text-center">
                                    <h5 class="mb-0">Welcome Back !</h5>
                                    <p class="text-muted mt-2">Sign in to continue to Iziko de Lounge.</p>
                                </div>
                            ...
                            <div class="mt-4 mt-md-5 text-center">
                                <p class="mb-0">© <script>
                                    ...
                                    </script> Iziko de Lounge . Created by  <a href="https://webistezar.co.za">WebsiteZar</a></p>
                            </div>
                        </div>
                    </div>
                </div>
