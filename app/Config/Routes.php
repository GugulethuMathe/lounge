...
$routes->get('/staff', 'Manager::admins');
$routes->get('/administrators', 'Manager::admins');
$routes->get('/fetch-administrators', 'Manager::readAdmins');

//Packages
$routes->get('/packages', 'Package::index');
$routes->get('/fetch-packages', 'Package::readPackages');

//Catergories
$routes->get('/catergories', 'Catergories::index');
$routes->get('/fetch-catergories', 'Catergories::readCatergories');

//Rooms
$routes->get('/rooms', 'Room::index');
$routes->get('/fetch-rooms', 'Room::readRooms');
$routes->get('add-product-to-package/(:any)', 'Viewproductpackage::index/$1');
